...
\newcommand{\NNT}{TODO Numéro National de Thèse} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\defensedate}{June, 24$^\text{th}$ 2019} 															%% Date de soutenance / Date of defense
...
\newcommand{\jurynameG}{Guyon Isabelle}
\newcommand{\juryadressG}{Professor, University of Paris Saclay (LRI)}
\newcommand{\juryroleG}{Co-directeur de thèse}

%%% Membre n°8 (Invité) / Member n°8 (Guest)
\newcommand{\jurynameH}{Guest 1}
\newcommand{\juryadressH}{Mordor, Middle land}
\newcommand{\juryroleH}{Guest}
