...
\begin{figure}[ht!]
  ...
  \caption{MSE according to the number of samples on nominal data only. Each curve correspond to a model with a specific set of hyper-parameter.}
...
\begin{figure}[ht!]
  ...
  \caption{MSE according to the number of samples. Each curve correspond to a model with a specific set of hyper-parameter. here only the value of $\mu$ is kept as nominal.}
