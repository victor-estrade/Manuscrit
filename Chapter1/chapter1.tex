...
But if the data spaced is binned in a non-trivial way, e.g. with a histogram on the score of a classifier, the valeus of $\gamma_i$ and $\beta_i$ requires to be estimated.
