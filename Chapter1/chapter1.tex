...
\victor{TODO : Est-ce qu'on doit introduire ce concept ? Parce que au final les estimations du nombre attendu de signal et bruit de fond sont fait avec des datasets provenant de la simulation (c'est ça l'asimov dataset ?).}
...
\subsection{Recipies to reduce systematic unceratinties} % (fold)
...
According to neyman-Pearson the likelihood ratio between the 2 hypothesis is a sufficient summary statistic for the hypothesis test.
\begin{align}
...
But if you ant a Frequentist approach you use the profiled likelihood ratio method.
...
And read \url{https://arxiv.org/pdf/physics/0408039.pdf} for coverage of teh Bayesiand approach.
I read only introduction and conclusion of these paper and they state tha Frequentist method leads to a small under-coverage and the Bayesian approach leads to a small over-coverage.
