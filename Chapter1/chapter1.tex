...
Of course the belief of the community is only based on results the previous experiments
...
The poisson count likelihood (see \autoref{sub:poisson_count_process}) is modified with the introduction of the nuisance parameter $\alpha$.
