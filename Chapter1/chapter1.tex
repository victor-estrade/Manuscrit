...
\isabelle{Faire + attention sur le vocabulaire.  Bien définir les termes. Associer MLE avec MAP sans le concept de cas particulier.}
...
Those regions are most commonly called \emph{bins} (or histogram bins) because the event counting in regions very often rely on building a histogram.
...
And one more : \url{https://pdg.lbl.gov/2009/reviews/rpp2009-rev-statistics.pdf} !  this last one is a bit more clear I think.
