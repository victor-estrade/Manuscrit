...
How do I prove that $max \sum_{i=1}^K n_i \frac{\gamma_i^2}{(\mu \gamma_i + \beta_i)^2}$ is found when $\gamma_i$ and $n_i$ is big and $\beta_i$ is small in a few bins... Not forgetting that the total number of events is restricted.
