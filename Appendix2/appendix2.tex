...
Pour pouvoir en parler je dois introduire :
\begin{itemize}
...
Il faut aussi parler des solutions actuelles et autres empreints à la litterature
\begin{itemize}
...
Que je me positionne par rapport à d'autres alternatives non explorées:
\begin{itemize}
...
Présentation du benchmark ie des données, des XP, etc
\begin{itemize}
