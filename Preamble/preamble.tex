...
% \ifsetDraft
	...
	\newcommand{\benjamin}[1]{\todo[size=\small,inline,color=green!40]{#1  \-- Benjamin}}
	\newcommand{\isabelle}[1]{\todo[size=\small,inline,color=red!50]{#1  \-- Isabelle}}
	\newcommand{\balthazar}[1]{\todo[size=\small,inline,color=orange]{#1 \-- Balthazar}}
	\newcommand{\antoine}[1]{\todo[size=\small,inline,color=amethyst]{#1 \-- Antoine}}
	\newcommand{\marc}[1]{\todo[size=\small,inline,color=orange]{#1 \-- Marc}}
	\newcommand{\patrick}[1]{\todo[size=\small,inline,color=amethyst]{#1 \-- Patrick}}
	\newcommand{\remy}[1]{\todo[size=\small,inline,color=amethyst]{#1 \-- Remy}}
	\newcommand{\nicolas}[1]{\todo[size=\small,inline,color=red!50]{#1  \-- Nicolas}}
    
	\newcommand{\louis}[1]{\todo[size=\small,inline,color=amethyst]{#1 \-- Louis Wehenkel}}
	\newcommand{\liva}[1]{\todo[size=\small,inline,color=orange]{#1  \-- Liva Ralaivola}}
%\else
% \newcommand{\mynote}[1]{}
